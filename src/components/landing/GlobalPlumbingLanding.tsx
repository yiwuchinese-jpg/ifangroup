...
const globalPlumbingFaqs: [string, string][] = [
  ...
  ["What full product range can I source from one order?", "One supplier for the whole system: PPR pipe DN20–DN160 in PN12.5–PN25, plus fittings, valves, composite pipe and floor-heating, and PVC/UPVC/CPVC, PPH, HDPE (PE100/PE80), PEX and multilayer pipe, and CW617N brass valves and faucets. MOQ is one container and you can mix sizes and products inside it."],
