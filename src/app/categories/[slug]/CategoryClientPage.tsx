...
// Generic types, we no longer need the CMS specific product fetch here
export default function CategoryClientPage({
    ...
    // Array of high-quality placeholder images for the "Showcase Gallery"
    // User will replace these via CMS or direct code update later with their composite/lifestyle shots
    // Standardized local paths: /images/categories/[slug]/gallery-[1-8].webp
    ...
    return (
        <div className="flex min-h-screen flex-col bg-slate-50 relative selection:bg-brand-200 selection:text-brand-900">
            ...
            <main className="flex-grow">
                {/* 1. Immersive Hero Section - High Impact First Impression */}
                <section className="relative w-full min-h-[85vh] flex items-center justify-start overflow-hidden bg-slate-950 pt-32 lg:pt-40 pb-20">
                    <div className="absolute inset-0 w-full h-full z-0 overflow-hidden">
                        {/* Dramatic background image to set the tone */}
                        <img 
                            src={`/images/categories/${slug}/hero-bg.webp`} 
                            alt={`${copy.heroTitle} Background`} 
                            ...
                            >
                                ...
                                <div className="flex flex-col sm:flex-row items-center gap-6">
                                    ...
                                    <div className="flex items-center gap-4 text-slate-400 text-sm font-medium">
                                        ...
                                        <span>Trusted by 5,000+ Enterprise Clients</span>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
                ...
                {/* 2. Signature Product (Hero Extension) - White modern section */}
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                            ...
                            >
                                <div className="inline-flex items-center gap-2 text-brand-600 font-bold uppercase tracking-widest mb-6 border border-brand-100 bg-brand-50 px-4 py-2 rounded-full w-max text-xs">
                                    <ShieldCheck className="w-4 h-4" /> Signature Component
                                </div>
                                <h2 className="text-5xl lg:text-7xl font-black text-slate-900 tracking-tighter mb-8 leading-[1.05]">
                                    The Core of <br/><span className="text-brand-600">{copy.heroTitle.split(" ")[0]}</span> Systems.
                                </h2>
                                <p className="text-slate-600 text-xl leading-relaxed mb-10 font-light max-w-lg">
                                    Our flagship component embodies the pinnacle of our engineering capabilities. Featuring extreme pressure tolerance, zero-leakage fusion zones, and a design life exceeding 50 years.
                                </p>
                                <Link
                                    href="/products"
                            ...
                            >
                                <div className="relative w-full max-w-xl flex items-center justify-center p-8 lg:p-12">
                                    {/* Ambient radial glow under the floating product */}
                                    ...
                                    <div className="absolute bottom-0 right-0 lg:right-10 bg-slate-900 border border-slate-800 px-4 py-2 z-20 shadow-2xl">
                                        <p className="text-[10px] font-bold text-white uppercase tracking-widest">[REPLACE WITH TRANSPARENT PNG]</p>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
                ...
                {/* 3. EEAT Trust Banner (Experience & Authority) */}
                ...
                {/* 3. Value Proposition & Technical Breakdown (Expertise) */}
                <section className="py-24 lg:py-40 bg-slate-50 relative">
                    <div className="container mx-auto px-6 max-w-7xl">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
                            {/* Left Column: Big Tagline & Intro */}
                            <motion.div 
                                initial={{ opacity: 0, x: -30 }}
                                whileInView={{ opacity: 1, x: 0 }}
                            ...
                            >
                                ...
                                <p className="text-lg text-slate-600 font-medium leading-relaxed mb-10">
                                    IFAN manufacturing consistently pushes the boundary of what's possible in raw material science and extrusion precision. We don't just supply components; we architect the lifelines of global infrastructure.
                                </p>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start gap-4 p-6 bg-white border border-slate-200 shadow-sm">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-slate-900 mb-2">Uncompromising Raw Materials</h4>
                                            <p className="text-sm text-slate-500 leading-relaxed">Sourced exclusively from industry-leading global chemical titans to ensure absolute metallurgical and polymer integrity.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 p-6 bg-white border border-slate-200 shadow-sm">
                                        <CheckCircle2 className="w-8 h-8 text-brand-500 shrink-0 mt-1" />
                                        <div>
                                            <h4 className="font-bold text-slate-900 mb-2">Rigorous Factory QA</h4>
                                            <p className="text-sm text-slate-500 leading-relaxed">Every batch undergoes severe stress, thermal, and hydrostatic testing before leaving our facilities.</p>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>

                            {/* Right Column: Detailed Sections from CMS Copy */}
                            <motion.div 
                                initial={{ opacity: 0, x: 30 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                viewport={{ once: true, margin: "-100px" }}
                            ...
                            >
                                ...
                                <div className="bg-slate-900 text-white p-12 lg:p-16 hover:shadow-2xl transition-all duration-500 relative overflow-hidden group">
                                    ...
                                    <h3 className="text-3xl font-black tracking-tight mb-6">
                                        {copy.technicalSuperiority.title}
                                    </h3>
                                    <div className="w-16 h-1 bg-brand-500 mb-8"></div>
                                    <p className="text-xl text-slate-300 leading-relaxed font-light">
                                        {copy.technicalSuperiority.description}
                                    </p>
                                </div>
                ...
                {/* 4. High-End Visual Showcase Gallery (Replacing basic single-product grid) */}
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                            <div className="max-w-3xl">
                                ...
                                <h2 className="text-4xl md:text-5xl lg:text-7xl font-black text-slate-900 tracking-tighter leading-[0.9]">
                                    {copy.heroTitle.split(" ")[0]} <br /> Showcase.
                                </h2>
                            </div>
                            <div className="max-w-md text-slate-500 font-medium text-lg leading-relaxed">
                                Explore our flagship components and comprehensive architectural applications. 
                            </div>
                        </div>

                        {/* Bento-box style High-End Gallery */}
                            ...
                            >
                                <Link href="/products" className="block w-full h-full cursor-pointer">
                                    ...
                                    <div className="absolute bottom-8 left-8 right-8 translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 text-white flex items-end justify-between">
                                        <div>
                                            <p className="font-bold tracking-widest text-xs uppercase mb-2 text-brand-400">Premium Composition</p>
                                            <h4 className="text-2xl font-bold">Industrial Grade Implementation</h4>
                                        </div>
                ...
                {/* 5. Contact / Fast-Track Quoting CTA (High CONVERSION) */}
                <section className="py-24 lg:py-32 bg-slate-950 relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 max-w-5xl text-center relative z-10">
                        ...
                        <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter mb-8 leading-tight">
                            Ready to Source the Global Standard?
                        </h2>
                        <p className="text-slate-400 text-xl md:text-2xl mb-12 max-w-3xl mx-auto font-light leading-relaxed">
                            Bypass the middleman. Submit your project requirements to our enterprise team for priority quoting, custom OEM modifications, and immediate supply chain integration.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            ...
                            >
                                Request Source Factory Pricing
