...
import { ArrowRight, CheckCircle2, FileText, ShieldCheck, Box, Settings } from "lucide-react";
                    ...
                    <div className="flex flex-col lg:flex-row gap-16">
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col justify-center">
                            ...
                            <p className="text-xl text-slate-500 font-light leading-relaxed mb-10">
                                {product.description || "Premium industrial component engineered for global infrastructure and high-pressure residential networks."}
                            </p>

                            <div className="grid grid-cols-2 gap-4 mb-10">
                                <div className="p-4 bg-slate-50 border border-slate-100 rounded-2xl">
                                    <ShieldCheck className="w-6 h-6 text-brand-600 mb-2" />
                                    <p className="text-xs font-bold text-slate-400 uppercase">Durability</p>
                                    <p className="font-bold text-slate-900">50 Year Warranty</p>
                                </div>
                                <div className="p-4 bg-slate-50 border border-slate-100 rounded-2xl">
                                    <Box className="w-6 h-6 text-brand-600 mb-2" />
                                    <p className="text-xs font-bold text-slate-400 uppercase">Material</p>
                                    <p className="font-bold text-slate-900">Virgin Grade A+</p>
                                </div>
                            </div>
                    ...
                    <div className="mt-24 pt-24 border-t border-slate-100">
                        <div className="mb-12">
                            <h2 className="text-3xl font-black text-slate-900 mb-4 flex items-center gap-3">
                                <FileText className="text-brand-600" /> Technical Specification Matrix
                            </h2>
                            <p className="text-slate-500">Precise measurements and packaging standards for wholesale procurement.</p>
                        </div>
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-slate-50 border-b border-slate-200">
                                        <th className="p-6 text-xs font-bold text-slate-400 uppercase tracking-widest">Article Code</th>
                                        <th className="p-6 text-xs font-bold text-slate-400 uppercase tracking-widest">Size (mm/inch)</th>
                                        <th className="p-6 text-xs font-bold text-slate-400 uppercase tracking-widest">Packing Count</th>
                                        <th className="p-6 text-xs font-bold text-slate-400 uppercase tracking-widest">CBM/Carton</th>
                                    </tr>
                                </thead>
