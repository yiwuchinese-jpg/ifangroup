                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                            ...
                            <div className="lg:col-span-5 flex flex-col gap-6 lg:gap-8">
                                    ...
                                    <div className="space-y-6 md:space-y-8">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-brand-100/80 text-sm leading-relaxed">Diankou Industrial Zone, Zhuji City,<br />Zhejiang Province, China</p>
                                            </div>
                                        </div>
                                ...
                                <div className="p-8 md:p-10 bg-white border border-slate-200">
                                    <h3 className="text-lg font-black tracking-tight text-slate-900 mb-6">Why Direct Procurement?</h3>
                                    <ul className="space-y-4">
                                        <li className="flex items-center gap-3 text-sm text-slate-600 font-medium">
                                            <CheckCircle2 className="w-5 h-5 text-brand-600 shrink-0" /> Factory Floor Pricing (0% Markup)
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-slate-600 font-medium">
                                            <CheckCircle2 className="w-5 h-5 text-brand-600 shrink-0" /> Custom OEM/ODM Capabilities
                                        </li>
                                        <li className="flex items-center gap-3 text-sm text-slate-600 font-medium">
                                            <CheckCircle2 className="w-5 h-5 text-brand-600 shrink-0" /> Priority Global Shipping Logistics
                                        </li>
                                    </ul>
                                </div>
                            </div>
